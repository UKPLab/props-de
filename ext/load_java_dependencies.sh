...
wget https://drive.google.com/uc?export=download&id=0B-qbj-8rtoUMLUg5NGpBVW9JNkE -O mate-model/parser-ger.model

# JoBimText Dependency Collapsing
wget http://maggie.lt.informatik.tu-darmstadt.de/jobimtext/wordpress/wp-content/uploads/2015/10/collapsing-asl.zip -O collapsing-asl.zip
